...
// Gyro Turn
float Kp_turn = 9.75, Ki_turn = 0.015, Kd_turn = 0.975;//9.75-0.015-0.975
float GYRO_SCALE = (90.0/60.0); // ค่าแก้สเกล Gyro จากโค้ดเก่า
...
void forceBrake() {
  ...
  setSpeed(-255, -255); 
  delay(20); // <-- ลองปรับค่านี้ดู (50 ถึง 150 ms)
