...
// =========================================
const float KP_WALL = 8.5;       // แรงดึงกลับเข้ากลาง (ถ้าวิ่งชนกำแพงให้เพิ่ม, ถ้าส่ายให้ลด)
const float KD_WALL = 15.00;      // แรงหน่วงการส่าย (ช่วยหยุดการแกว่ง) <-- เพิ่มตัวนี้
const int WALL_CENTER_DIST = 75; // ระยะห่างจากกำแพงที่ต้องการ (mm)
...
// ... existing variables ...
const int CELL_DISTANCE_TICKS = 1180; 
...
bool wallFront() {  
    ...
    return (getDistanceMM(0) < 50 || getDistanceMM(1) < 50); 
} 
